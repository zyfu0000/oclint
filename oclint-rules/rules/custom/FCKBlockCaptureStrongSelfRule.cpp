...
class FCKBlockCaptureStrongSelfRule : public AbstractASTVisitorRule<FCKBlockCaptureStrongSelfRule>
{
public:
    virtual const string name() const override
    {
        return "block capture strong self";
    }
...
static RuleSet rules(new FCKBlockCaptureStrongSelfRule());
