...
class url:
    ...
    clang_prebuilt_binary_for_macos = 'http://releases.llvm.org/7.0.0/clang+llvm-7.0.0-x86_64-apple-darwin.tar.xz'
    clang_prebuilt_binary_for_ubuntu = 'http://releases.llvm.org/7.0.0/clang+llvm-7.0.0-x86_64-linux-gnu-ubuntu-14.04.tar.xz'
